...
from conode.domain.company.errors import CompanyDomainValidationError
from conode.domain.context.errors import ContextDomainValidationError
from conode.domain.edge.errors import EdgeDomainValidationError
from conode.domain.group.errors import GroupDomainValidationError
from conode.domain.node.errors import NodeDomainValidationError
from conode.domain.role.errors import RoleDomainValidationError
from conode.domain.user.errors import UserDomainValidationError
...
EXCEPTION_HANDLERS: Final[dict[type[ApplicationError], HTTPStatus]] = {
    ...
    OfferNotFoundError: HTTPStatus.NOT_FOUND,
    OfferLinkNotFoundError: HTTPStatus.NOT_FOUND,
    ...
    CannotTransferCompanyToCurrentOwnerError: HTTPStatus.CONFLICT,
    EmailsOfAllParticipantsMustBeVerifiedError: HTTPStatus.UNPROCESSABLE_CONTENT,
    TargetUserAccountCreatedTooRecentlyError: HTTPStatus.UNPROCESSABLE_CONTENT,
