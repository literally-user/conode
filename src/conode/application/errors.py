...
class OfferNotFoundError(ApplicationError): ...


class OfferLinkNotFoundError(ApplicationError): ...


class DepthCannotBeNegativeError(ApplicationError): ...


class CannotTransferCompanyToCurrentOwnerError(ApplicationError): ...


class EmailsOfAllParticipantsMustBeVerifiedError(ApplicationError): ...


class TargetUserAccountCreatedTooRecentlyError(ApplicationError): ...
