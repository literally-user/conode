...
class AccessControlService:
    ...
    def ensure_user_can_manipulate_group(
        self, executor: User, executor_company: Company, group: Group
    ) -> None:
        if executor_company.id != group.company_id and not executor.is_admin():
            raise NotEnoughRightsError("Not enough rights to perform operation", None)
